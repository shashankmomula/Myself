...
const Body =()=>{
  ...
  <h2 className="h-10 h-12">
    and I am good at{' '}
    <span className="text-yellow-800 font-serif inline-block">
      <Typewriter
        words={['HTML', 'Javascript', 'React', 'C++', 'DSA', 'Java', 'Redux', 'Tailwind', 'Node.js','Express.js']}
        loop={5}
        cursor
        cursorStyle="|"
        typeSpeed={70}
...
<div className="flex sm:ml-36">
  ...
  <img src={LOGO} className="w-44 h-44 mt-6 sm:w-80 sm:h-80 sm:mt-20" />
</div>
