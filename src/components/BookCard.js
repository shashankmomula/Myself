...
function BookCard({ image, description }) {
  ...
  return (
    <div className="shadow-black rounded-lg overflow-hidden">
        ...
        <div className="p-5 md:p-7">
          <p
            className={`transition-all duration-300 ${
              isVisible ? "max-h-screen" : "max-h-16 overflow-hidden"
            }`}
          >
            {description}
          </p>
      ...
      {isVisible && (
        <div className="p-5 md:p-7 flex justify-end ">
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            <img src={AMAZON} className="w-10 h-10 mt-5 ml-1 cursor-pointer rounded-3xl" />
          </a>
        </div>
      )}
    </div>
